...
public class TestOpenCv2 {
    ...
    static {
        ...
        faceDetector = new CascadeClassifier("F:\\openCvFile\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
    }
